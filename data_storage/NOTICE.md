...
**Files:** `perfect_jump_processed.csv`, `perfect_jump_ground_aligned.csv`,
`perfect_jump_ankle_feasible.csv`, `perfect_jump_extended.csv`.
...
The other CSVs here are derived from that trajectory by the post-processing steps under
[`scripts/g1_jump_deploy/retarget/`](../scripts/g1_jump_deploy/retarget).
